...
\033[1;32m[-] AUTHOR    :\033[1;32m AKASH AHMED

\033[1;32m[-] GITHUB    :\033[1;32m MD-AK4SH-V4U

\033[1;32m[-] FACEBOOK  :\033[1;32m Md. Jaidual Islam
...
if 'AKASH'==user and 'V4U'==pas:

	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")

	os.system('xdg-open https://www.facebook.com/profile.php?id=100084577955599')
	...
	os.system("xdg-open https://wa.me/+8801754024388")
...
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH AK4SH-V4U ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥AK4SH-V4U🔥 "+w+tim)
